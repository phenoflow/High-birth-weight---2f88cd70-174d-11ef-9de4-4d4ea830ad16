...
(async () => {
  ...
  await fs.writeFile("high-birth-weight-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("high-birth-weight-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
